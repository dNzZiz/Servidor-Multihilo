...
import Cliente_Recibe_Servidor_Envia.*;
...
public class ClienteFichero{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        cf.enviarOpcion();
        cf.pide("Numeros.txt", "localhost", 5000);
        System.out.println("Cliente pide el archivo Numeros.txt");
    }
     ...
     *            Puerto de conexi�n
     */
    public void enviarOpcion() throws IOException {
    ...
    public void pide(String fichero, String servidor, int puerto)
    {
        try
        {
            ...
            FileOutputStream fos = new FileOutputStream("Repositorio/"+mensaje.nombreFichero
                    + "_copia");
